...
<?php
            ...
            $fname = $lname = $email =  $bgroup = $gender =$bdate= "";
                ...
                // </script>";
                    echo"<script>                      
                       alert('Redirecting to a different page to Upload an Image');
                        window.location.href='http://localhost/webpage/coach/confirm_registration.php?fname=$fname&lname=$lname&email=$email&group=$bgroup&gender=$gender&date=$bdate';
                    // myFunction();
                    </script>";
            }   
        ?>
                        ...
                        <div class="row">
                            <div class="col-50">
                                ...
                                <div class="col-500">
                                    ...
                                    <input type="radio" value="1" id="group" name="group" <?php if(isset($_POST['group']) && $_POST['group'] =='1') echo "checked"?> >Defensive line Coach  <br>
                                    <input type="radio" value="2" id="group" name="group" <?php if(isset($_POST['group']) && $_POST['group'] =="2") echo "checked"?>>Linebacker Coach <br>
                                    <input type="radio" value="3" id="group" name="group" <?php if(isset($_POST['group']) && $_POST['group'] =="3") echo "checked"?>>Offensive line Coach <br>
                                    <input type="radio" value="4" id="group" name="group" <?php if(isset($_POST['group']) && $_POST['group'] =="4") echo "checked"?>>Quarterback Coach <br>
                                    <input type="radio" value="5" id="group" name="group" <?php if(isset($_POST['group']) && $_POST['group'] =="5") echo "checked"?>>Running backs Coach <br>
                                    <input type="radio" value="6" id="group" name="group" <?php if(isset($_POST['group']) && $_POST['group'] =="6") echo "checked"?>>Secondary Coach <br>
                                    <input type="radio" value="7" id="group" name="group" <?php if(isset($_POST['group']) && $_POST['group'] =="7") echo "checked"?>>Special Coach <br>
                                    <input type="radio" value="8" id="group" name="group" <?php if(isset($_POST['group']) && $_POST['group'] =="8") echo "checked"?>>Tight ends Coach <br>
                                    <input type="radio" value="9" id="group" name="group" <?php if(isset($_POST['group']) && $_POST['group'] =="9") echo "checked"?>>Wide receivers Coach <br>
                                ...
                                <div class="col-50">
                                    ...
                                    <input type="radio" value="male" id="gender" name="gender" <?php if(isset($_POST['gender']) && $_POST['gender'] =="male") echo "checked"?>>male <br>
                                    <input type="radio" value="female" id="gender" name="gender"<?php if(isset($_POST['gender']) && $_POST['gender'] =="female") echo "checked"?> >female <br>
                                    <input type="radio" value="other" id="gender" name="gender"<?php if(isset($_POST['gender']) && $_POST['gender'] =="other") echo "checked"?> >other <br>
