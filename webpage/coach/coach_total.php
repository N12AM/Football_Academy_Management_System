...
<div class="page">
    ...
    <div class="side">
        ...
        <div class="AddPlayerPending">
            <div class="AddPlayer" >
                <form action="http://localhost/webpage/coach/coach_total.php" method="POST" class="sortForm">
            ...
            <div class="AddPlayer searchPlayer" >
                <form action="http://localhost/webpage/players_search.php?where=coach_view" method="post" class="searchForm">
                    <input type="text" placeholder="search coach here" name="search" style="width:40%; padding:8px; margin-right:6%; ">
                ...
                <div class="prevButton">
                    <?php
                        if($go_to_previous_page)
                            echo '
                                <a href="http://localhost/webpage/coach/coach_total.php?sort='.$order_by.'&ascDesc='.$order_type.'&page='.$prev_page.'">Previous Page</a>';
                    ?>
                </div>
            </div>
            <div class="nextprevChild">
                ...
                if($go_to_next_page)
                 echo '
                    <a href="http://localhost/webpage/coach/coach_total.php?sort='.$order_by.'&ascDesc='.$order_type.'&page='.$next_page.'">Next Page</a>';
                ?>
                </div>
            </div>
        </div>
