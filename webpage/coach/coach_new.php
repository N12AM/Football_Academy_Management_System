    ...
    <div class="side">
        ...
        <div class="quickLookup">
            <div class="quickView qv1">
                ...
                <div class="viewPorts"><span class="emp_text">Total Coach</strong></span> </a></div>
                <div class="viewPortValue"> <span><?php echo $pCount[0];  ?></span>
                </div>
            </div>
        ...
        <div class="AddPlayerPending">
            <div class="AddPlayer" >
                <form action="http://localhost/webpage/coach/coach_new.php" method="POST" class="sortForm">
        ...
        <div class="nextprevParent">
            ...
            <div class="nextprevChild">
                ...
                if($go_to_previous_page)
                 echo '
                    <a href="http://localhost/webpage/coach/coach_new.php?sort='.$order_by.'&ascDesc='.$order_type.'&page='.$prev_page.'">Previous Page</a>';
                ?>
                </div>
            </div>
            <div class="nextprevChild">
                ...
                if($go_to_next_page)
                 echo '
                    <a href="http://localhost/webpage/coach/coach_new.php?sort='.$order_by.'&ascDesc='.$order_type.'&page='.$next_page.'">Next Page</a>';
                ?>
                </div>
            </div>
        </div>
