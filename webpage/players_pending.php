    ...
    <div class="page">
        ...
        <div class="side">
            ...
            <div class="dashboard" style="height:50px; text-align: left; font-size:23px; padding-left: 20px;;">
                ...
                <span style="font-family:'Aclonica',Arial, Helvetica, sans-serif;">Pending Applicants</span>
            </div>
            ...
            <div class="quickLookup">
                ...
                <div class="quickView qv2" style="background-color:#ff9800!important;">
                    ...
                    <div class="viewPorts"><a href="http://localhost/webpage/players_active.php?page=0" class="viewPortLink"><span class="emp_text">Active</strong></span></a></div>
                ...
                <div class="quickView qv3" style="background-color:#2196f3!important;">
                    ...
                    <div class="viewPorts"><a href="http://localhost/webpage/players_pending.php?page=0" class="viewPortLink"><span class="emp_text">Pending</span></a></div>
            ...
            <div class="AddPlayerPending">
                <div class="AddPlayer">
                    <form action="http://localhost/webpage/players_pending.php" method="POST" class="sortForm">
                ...
                <div class="AddPlayer searchPlayer">
                    <form action="http://localhost/webpage/players_search.php?where=applicants" method="post" class="searchForm">
            ...
            <div class="feeds">
                ...
                <table class="feedTable">
                    ...
                    <!-- id, full_name, city, phone, age, regDate -->
                    <?php
                    $p = 0;
                    //    if($result = $conn->store_result())
                ...
                <div class="nextprevChild">
                    <div class="prevButton">
                        ...
                        if ($go_to_previous_page)
                            echo '
                                    <a href="http://localhost/webpage/players_pending.php?sort=' . $order_by . '&ascDesc=' . $order_type . '&page=' . $prev_page . '">Previous Page</a>';
                        ?>
                    </div>
                </div>
                <div class="nextprevChild">
                    <div class="nextButton">
                        ...
                        if ($go_to_next_page)
                            echo '
                                    <a href="http://localhost/webpage/players_pending.php?sort=' . $order_by . '&ascDesc=' . $order_type . '&page=' . $next_page . '">Next Page</a>';
                        ?>
                    </div>
                </div>
            </div>
