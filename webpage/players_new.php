...
.AddPlayerPending{background-color:antwhiteiquewhite;padding:0px 8px;display: flex;margin-bottom: 16px!important;}
.AddPlayer{font-size: 20px;color:#000;margin-left:10px;width:50%;float:left;display:block;box-sizing: inherit;content:"";height:150px;bottom: 10;;}
.addPlayerLink{text-decoration: none;color:black !important;}
/* ---------------------------------------below style for SORT and SEARCH players */
.sortForm{padding:40px 0px;;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;font-size: 25px;text-align: left;;}
.sortForm > input{transform: scale(1.2);padding:5px 15px;background-color: #009680!important;color: white;font-weight: bold;font-size:16px;border-style: none;}
.searchPlayer{text-align:right;padding-right: 40px;}
.searchForm{padding-top:60px;}
.searchForm > input{transform: scale(1.3);}
...
@media(min-width: 700px){.container{padding-left: 10%;}}
</style>
...
<div class="page">
    ...
    <div class="side">
            ...
            <div class="dashboard" style="height:50px; text-align: left; font-size:23px; padding-left: 20px;;">
                ...
                <span style="font-family:'Aclonica',Arial, Helvetica, sans-serif;">New Players Today</span>
            </div>
            ...
            <div class="quickLookup">
                ...
                <div class="quickView qv1" style="background-color:#f44336!important;">
                    ...
                    <div class="viewPorts"><a href="http://localhost/webpage/players_total.php?page=0" class="viewPortLink"><span class="emp_text">Total</strong></span></a></div>
                ...
                <div class="quickView qv2" style="background-color:#ff9800!important;">
                    ...
                    <div class="viewPorts"><a href="http://localhost/webpage/players_active.php?page=0" class="viewPortLink"><span class="emp_text">Active</strong></span></div></a>   
                ...
                <div class="quickView qv3" style="background-color:#2196f3!important;">
                    ...
                    <div class="viewPorts"><a href="http://localhost/webpage/players_pending.php?page=0"class="viewPortLink"><span class="emp_text">Pending</span></div> </a>
                ...
                <div class="quickView qv4" style="background-color:#009680!important;">
                    ...
                    <div class="viewPorts"><a href="http://localhost/webpage/players_new.php?page=0" class="viewPortLink"><span class="emp_text">New Admitted</span></a></div>
            ...
            <div class="AddPlayerPending">
                <div class="AddPlayer" >
                    <form action="http://localhost/webpage/players_new.php" method="POST" class="sortForm">
                ...
                <div class="AddPlayer searchPlayer" >
                    <form action="http://localhost/webpage/players_search.php?query=new&where=playerbasicinfo" method="post" class="searchForm">
                    ...
                    <div class="prevButton">
                        <?php            
                            if($go_to_previous_page)
                                echo '
                                    <a href="http://localhost/webpage/players_new.php?sort='.$order_by.'&ascDesc='.$order_type.'&page='.$prev_page.'">Previous Page</a>';
                        ?>
                    </div>
                </div>
                <div class="nextprevChild">
                    <div class="nextButton">
                        <?php
                            ...
                            if($go_to_next_page)
                                echo '
                                    <a href="http://localhost/webpage/players_new.php?sort='.$order_by.'&ascDesc='.$order_type.'&page='.$next_page.'">Next Page</a>';
                        ?>
                    </div>
                </div>
            </div>
